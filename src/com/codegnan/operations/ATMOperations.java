...
public class ATMOperations {
	...
	public static IATMServices validCredentials(long cardNumber, int pinNumber)
	...
	public static void main(String[] args) throws NotAOperatorException {
		...
		dataBase.put(2222222222l, new AxisDebitcard(222222222l,"yesu",50000.0,2222));
